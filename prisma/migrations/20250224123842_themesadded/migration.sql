...
CREATE TABLE "ThemeMode" (
    ...
    CONSTRAINT "ThemeMode_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ThemeMode" ADD CONSTRAINT "ThemeMode_themeId_fkey" FOREIGN KEY ("themeId") REFERENCES "Theme"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Dislike" ADD CONSTRAINT "Dislike_themeId_fkey" FOREIGN KEY ("themeId") REFERENCES "Theme"("id") ON DELETE CASCADE ON UPDATE CASCADE;
